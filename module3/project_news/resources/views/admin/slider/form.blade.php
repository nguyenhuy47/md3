...
<head>
    ...
    <!-- Bootstrap -->
    <link href="admin/asset/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="admin/css/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="admin/asset/nprogress/nprogress.css" rel="stylesheet">
    <!-- iCheck -->
    <link href="admin/asset/iCheck/skins/flat/green.css" rel="stylesheet">
    <!-- PNotify -->
    <link href="admin/asset/pnotify/dist/pnotify.css" rel="stylesheet">
    <link href="admin/asset/pnotify/dist/pnotify.buttons.css" rel="stylesheet">
    <link href="admin/asset/pnotify/dist/pnotify.nonblock.css" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="admin/asset/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation" class="dropdown">
                            ...
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                <li>
                                    <a>
                                        <span class="image"><img src="admin/img/img.jpg" alt="Profile Image"/></span>
                                        <span>
...
<!-- Bootstrap -->
<script src="admin/asset/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- FastClick -->
<script src="admin/js/fastclick/lib/fastclick.js"></script>
<!-- NProgress -->
<script src="admin/asset/nprogress/nprogress.js"></script>
<!-- bootstrap-progressbar -->
<script src="admin/asset/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
<!-- iCheck -->
<script src="admin/asset/iCheck/icheck.min.js"></script>
<!-- PNotify -->
<script src="admin/asset/pnotify/dist/pnotify.js"></script>
<script src="admin/asset/pnotify/dist/pnotify.buttons.js"></script>
<script src="admin/asset/pnotify/dist/pnotify.nonblock.js"></script>
